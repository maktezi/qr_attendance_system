                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="/" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{ asset('applogo.png') }}" alt="logo-sm-light" height="35">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('applogo.png') }}" alt="logo-light" height="50">
                                </span>
                            </a>
                        </div>
                        ...
                        <form class="app-search d-none d-lg-block">
                            <div class="position-relative">
                                <input type="text" class="text-center form-control" placeholder="Attendance System">
            ...
            <div class="vertical-menu">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div class="user-profile text-center mt-3">
                        <div class="">
                            <img src={{ asset('assets/images/profile.png') }} alt="" class="avatar-md rounded-circle">
                        </div>
                        <div class="mt-3">
                            <h4 class="font-size-16 mb-1">{{ Auth::user()->fname }}</h4>
...
{{-- ADMIN SIDE --}}
                            @if (Auth::user()->role == 1)
                                ...
                                <li>
                                    ...
                                    <li><a href="{{ route('scanqr') }}" class="nav-link scrollto" style="font-weight: 900;"><i class="ri-qr-code-fill"></i>ScanQR</a></li>
                                </li>

                                <li class="menu-title">INFORMATION</li>
                                <li>
                                    <li><a href="{{ route('forms.admin') }}"><i class="far fa-list-alt"></i></i>Registration</a></li>
                                </li>

                                <li class="menu-title">DATA TABLE</li>
                                <li>
                                    <li><a href="{{ route('attendances.admin') }}"><i class="mdi-form-select"></i>Attended</a></li>
                                </li>
{{-- USER SIDE --}}
                            @elseif (Auth::user()->role == 0)
                            <li class="menu-title">USER</li>
                                <li>
                                    <li><a href="#"><i class="far fa-list-alt"></i></i>Form</a></li>
        ...
        <script src="{{ asset('assets/instascan.min.js') }}" type="text/javascript"></script>
