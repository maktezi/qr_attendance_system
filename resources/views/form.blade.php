                    ...
                    <form action="{{ route('store.form') }}" method="POST">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="details">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-sm-offset-1">
                                        <div class="form-group">
                                            ...
                                            <input name="fname" type="text" class="form-control" placeholder="First" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input name="lname" type="text" class="form-control" placeholder="Last" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input name="occupation" type="text" class="form-control" placeholder="Current work" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input name="address" type="text" class="form-control" placeholder="Brgy., Municipality" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-sm-offset-1">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input name="email" type="email" class="form-control" placeholder="e.g. email@mail.com" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            <label>Contact</label>
                                            <input name="contact" type="number" class="form-control" placeholder="e.g. 09876543210" required>
                                        </div>
                                    </div>
                            ...
                            <div class="text-center">
                                <br><button class='btn btn-finish btn-fill btn-info btn-wd btn-sm' type="submit">REGISTER</button>
                            </div>
